...
@section('title')
    @php
        $title = 'Ngân Hàng | Công ty Hoàng Phát';
    @endphp
@endsection
...
@section('js-other')
    ...
    <link rel="stylesheet" href="{{ asset('webhtml/assets/css/searchBuilder.bootstrap5.css')}}">
...
@section('content')
            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-4">
                        <h3 class="mb-2">Chỉnh sửa thông tin ngân hàng</h3>
                    ...
                    <form id="editUserForm" class="row g-3" method="POST" action="{{ route('staff.update') }}"
                        ...
                        @csrf
                        <div class="col-sm-12">
                            <label class="form-label" for="name">Tên ngân hàng<span
    ...
    <div class="offcanvas offcanvas-end" id="add-new-record">
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title" id="exampleModalLabel">Thông tin ngân hàng</h5>
    ...
    <script src="{{ asset('webhtml/assets/custom-js/bank.js') }}"></script>
