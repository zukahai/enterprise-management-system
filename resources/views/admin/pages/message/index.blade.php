...
@section('title')
    @php
        $title = "Tin nhắn | Công ty Hoàng Phát";
    @endphp
@endsection

@section('link-other-head')
    <link rel="stylesheet" href="{{asset('webhtml/assets/vendor/css/pages/app-chat.css')}}" />
@endsection
      ...
      <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
        <div
          ...
          <div class="avatar avatar-xl avatar-online">
            <img src="{{asset('webhtml/assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle" />
          </div>
          ...
          <div class="d-flex align-items-center me-3 me-lg-0">
            <div
              ...
              <img
                ...
                src="{{asset('webhtml/assets/img/avatars/1.png')}}"
                alt="Avatar" />
            </div>
        ...
        <div class="sidebar-body">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-online">
                  <img src="{{asset('webhtml/assets/img/avatars/13.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
            ...
            <li class="chat-contact-list-item active">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-offline">
                  <img src="{{asset('webhtml/assets/img/avatars/2.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
          ...
          <ul class="list-unstyled chat-contact-list mb-0" id="contact-list">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-offline">
                  <img src="{{asset('webhtml/assets/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-busy">
                  <img src="{{asset('webhtml/assets/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-busy">
                  <img src="{{asset('webhtml/assets/img/avatars/7.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-offline">
                  <img src="{{asset('webhtml/assets/img/avatars/8.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-busy">
                  <img src="{{asset('webhtml/assets/img/avatars/10.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
            ...
            <li class="chat-contact-list-item">
              <a class="d-flex align-items-center">
                <div class="flex-shrink-0 avatar avatar-busy">
                  <img src="{{asset('webhtml/assets/img/avatars/11.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="chat-contact-info flex-grow-1 ms-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex overflow-hidden align-items-center">
                ...
                <div class="flex-shrink-0 avatar">
                  <img
                    src="{{asset('webhtml/assets/img/avatars/2.png')}}"
                    alt="Avatar"
