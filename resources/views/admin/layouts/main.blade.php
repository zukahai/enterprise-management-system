...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('webhtml/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}" />
    <link rel="stylesheet"
        href="{{ asset('webhtml/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('home') }}" class="app-brand-link">
                        ...
                        {{-- </span> --}}
                        <span class="app-brand-text demo menu-text fw-bold">Hoàng Phát</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    @foreach ($menus as $menu)
                        @if (!isset($menu['role']) || $menu['role'] == auth()->user()->role->role_name)
                            <li class="menu-item active {{ $menu['name'] == $super ? 'open' : '' }}">
                                <a href="javascript:void(0);" class="menu-link menu-toggle">
                                    ...
                                    @if (isset($menu['role']))
                                        <div class="badge bg-primary rounded-pill ms-auto">{{ $menu['role'] }}</div>
                                    @endif
                                </a>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('webhtml/assets/img/avatars/1.png') }}"
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('webhtml/assets/img/avatars/2.png') }}"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('webhtml/assets/img/avatars/9.png') }}"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('webhtml/assets/img/avatars/5.png') }}"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('webhtml/assets/img/avatars/6.png') }}"
                                                                alt class="h-auto rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                        ...
                                        <div class="avatar avatar-online">
                                            <img src="{{ asset(auth()->user()->avata) }}" alt
                                            ...
                                            <a class="dropdown-item" href="pages-account-settings-account.html">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span
                                                            class="badge badge-light-success">{{ auth()->user()->role->role_name }}</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
