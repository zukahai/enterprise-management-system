  ...
  if (dt_basic_table.length) {
    ...
    dt_basic = dt_basic_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">Thêm đơn vị</span>',
          className: 'create-new btn btn-primary waves-effect waves-light'
        }
      ],
    });
    $('div.head-label').html('<h5 class="card-title mb-0">Danh sách đơn vị/h5>');
  }
  ...
  $('.datatables-basic tbody').on('click', '.delete-record', function () {
    ...
    $.ajax({
      ...
      if (Math.floor(data.data > 0)) {
        ...
        toastr.error("Xóa đơn vị thất bại");
      }
